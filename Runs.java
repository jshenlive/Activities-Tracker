...
//-----------------------------------------
public class Runs extends OnLand {
    //Constant variable of class label
    final private String LABEL = "Runs";

    //Constructor
    public Runs(String[] data) {
        super(data);
    ...
    public boolean isSame(Activity data) {
        if (super.isSame(data)) {
            return this.getDistance() == ((Runs) data).getDistance() && this.getElevation() == ((Runs) data).getElevation();
        }
        return false;
    }
    ...
    // printActivity
    //
    // PURPOSE:  calls super class printActivity, and prints all instance variables onto the console
    //------------------------------------------------------
